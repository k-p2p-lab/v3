...
> 이 문서는 2026-09-08의 대조 기록입니다. 2026-09-09에는 여러 실행 비교·필터·CSV/SVG 내보내기 UI를 제거하고 **결과별 PNG 이미지 보기**로 줄였습니다. 현재 화면은 [결과 이미지 사용법](visualization.kr.md)을 따릅니다. 아래의 당시 UI 설명은 변경 전 상태입니다.
